...
Mes nouveaux tests ont permis d'atteindre 100% de couverture de mutation pour cette classe et d'améliorer le score global du package de 88% à 93%.
...
Nous ne vérifions pas la date exacte formatée car Faker génère des dates aléatoires, mais nous vérifions que la structure est correcte.
...
Nous avons exécuté **PITEST** sur la classe `ParsedCalendar`. Le plugin a été ajouté dans le pom.xml du module graphhopper.core (voir [ici](../core/pom.xml#L176)).
...
Ces résultats montrent que nos tests ont significativement augmenté le score de mutation et renforcé la couverture effective.
